# Generated by Powerlevel10k configuration wizard on 2021-05-28 at 10:58 CEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 40485.
# Wizard options: awesome-fontconfig, large icons, rainbow, unicode, 12h time,
# flat heads, flat tails, 2 lines, solid, full frame, lightest-ornaments, compact,
# many icons, concise, transient_prompt, instant_prompt=quiet.
